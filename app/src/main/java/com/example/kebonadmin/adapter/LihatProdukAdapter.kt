...
class LihatProdukAdapter(
    private var data: List<Transaksi>,
    private val listener: (Transaksi) -> Unit
) : RecyclerView.Adapter<LihatProdukAdapter.LeagueViewHolder>() {
    ...
    class LeagueViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(
            ...
            tvIdTransaksi.text = data.id_transaksi
            tvtotal.text = "Rp" + data.total_biaya.toString()
            tvTglPembayaran.text = data.tgl_transaksi.toString()
