...
class ProdukJasaKonfirmasiAdapter(
    private var data: List<Detail_Jasa>,
    private val listener: (Detail_Jasa) -> Unit
) : RecyclerView.Adapter<ProdukJasaKonfirmasiAdapter.LeagueViewHolder>() {
    ...
    class LeagueViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val tvNamaProduk: TextView =
            view.findViewById(R.id.tv_nama_produk_detail_konfirmasi)
        private val tvJumlahProduk: TextView =
            view.findViewById(R.id.tv_jumlah_beli_produk_detail_konfirmasi)
        private val tvHargaProduk: TextView =
            view.findViewById(R.id.tv_harga_beli_produk_detail_konfirmasi)
        ...
        fun bindItem(
            ...
            tvJumlahProduk.text = data.jumlah_jasa
